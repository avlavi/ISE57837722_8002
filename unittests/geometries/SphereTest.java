...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        result = sphere.findIntersections(new Ray(new Point(1, 0, 0), new Vector(0.53, 0.84, 0)));
        ...
        result = sphere.findIntersections(new Ray(new Point(0, 0, 0), new Vector(0.53, 0.84, 0)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(p2), result, "Ray crosses sphere");
        ...
        result = sphere.findIntersections(new Ray(new Point(0, 0, 0), new Vector(0, 1, 0)));
        assertEquals(0, result.size(), "Wrong number of points");
